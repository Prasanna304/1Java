...
public class K_ExcelTableCreationWithFormat {
	...
	public static void main(String[] args) throws IOException {
        ...
        cell.setCellValue("Align Center");
        ...
        // Create a headder
        XSSFSheet sheet2 = workbook.createSheet("Header Sheet");  
        // Creating Header  
        Header header2 = sheet2.getHeader();  
        header2.setCenter("Center Header");  
        header2.setLeft  ("Left Header");  
        header2.setRight ("Right align Header");  
        // Creating Row  
        XSSFRow row2 = sheet2.createRow(4);
        XSSFCell cell2 = row2.createCell(1);
        cell2.setCellValue("Headder!");  
        
        
        // Hide a row 
        row2 = sheet2.createRow(5);
        cell2 = row2.createCell(1);
        cell2.setCellValue("Hide row");
        row2.setHeightInPoints(0);; 
        
        
        /* Doesn't work will check when i am free
        ...
        anchor.setRow2(row.getRowNum() + 5); //...and 4 rows high
        Drawing drawing = sheet.createDrawingPatriarch();
		Comment comment = drawing.createCellComment(anchor);
        //set the comment text and author
        comment.setString(factory.createRichTextString("This is comment"));
        comment.setAuthor("Prasanna");
